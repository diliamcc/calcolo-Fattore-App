    ...
    <div class="container custom-container">
        ...
        <form id="kxpo-form">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="length" name="length" min="1" required>
            </div>

            <!-- Pescaggio a Pieno Carico (T_sc) -->
            <div class="form-group">
                <label for="t_sc" class="form-label">Pescaggio a Pieno Carico (T_sc) (m)</label>
                <input type="number" step="0.01" class="form-control" id="t_sc" name="t_sc" min="1" required>
            </div>
